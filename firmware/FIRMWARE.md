...
> 3-Key Cherry MX Macropad · Seeeduino XIAO SAMD21
...
|--------|----------|-------------|-------------|---------|
| SW1 (left) | Pin 11 | D10 | PA06 | `Net-(U1-PA6_A10_D10_MOSI)` |
| SW2 (middle) | Pin 10 | D9 | PA05 | `Net-(U1-PA5_A9_D9_MISO)` |
| SW3 (right) | Pin 9 | D8 | PA07 | `Net-(U1-PA7_A8_D8_SCK)` |
...
|-------------|-------------|----------|-------------|
| SW1 (left) | 1 | 0x1E | Number key 1 |
| SW2 (middle) | 2 | 0x1F | Number key 2 |
| SW3 (right) | 3 | 0x20 | Number key 3 |
