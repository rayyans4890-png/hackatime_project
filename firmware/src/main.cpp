 ...
 * PCB:  5-key Cherry MX macropad (28 mm × 83 mm)
 *
 ...
 *   [1] [2] [3] [4] [5]
 *
 * Number keys 1–5 on the keyboard.
 *
 * Build:   pio run
...
static const uint8_t KEY_PINS[] = {
    ...
    D7,     // SW4 → D7  / RX    (XIAO Pin 8,  PB09/A7)
    D4,     // SW5 → D4  / SDA   (XIAO Pin 5,  PA08/A4)
};
...
static bool     key_active[NUM_KEYS]  = {false, false, false, false, false};
static bool     key_prev[NUM_KEYS]    = {false, false, false, false, false};
static uint32_t debounce_t[NUM_KEYS]  = {0, 0, 0, 0, 0};
